...
const Comment = ({ comment, index = 0, isDarkMode = false, onUpdate, onDelete, currentUser = null }) => {
      ...
      <div className="notification-container">
        <div className={`notification ${isDarkMode ? 'dark-mode' : ''}`}>
          ...
          <header>
            ...
            {/* Boutons d'action - seulement si propriétaire ou admin */}
            {(currentUser && (comment.userId === currentUser.id || isAdmin())) && (
...
export const CommentList = ({ comments = [], autoDarkMode = false, onUpdateComment, onDeleteComment, currentUser = null }) => {
